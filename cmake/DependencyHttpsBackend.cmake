...
IF(HTTPS_BACKEND)
	...
	IF (HTTPS_BACKEND STREQUAL "SecureTransport")
		...
		SET(GIT_SECURE_TRANSPORT 1 PARENT_SCOPE)
		ADD_LIBRARY(HttpsBackend INTERFACE)
		TARGET_INCLUDE_DIRECTORIES(HttpsBackend SYSTEM INTERFACE ${SECURITY_INCLUDE_DIR})
		TARGET_LINK_LIBRARIES(HttpsBackend INTERFACE ${COREFOUNDATION_LDFLAGS} ${SECURITY_LDFLAGS})
	...
	ELSEIF (HTTPS_BACKEND STREQUAL "OpenSSL")
		...
		SET(GIT_OPENSSL 1 PARENT_SCOPE)
		ADD_LIBRARY(HttpsBackend INTERFACE)
		TARGET_INCLUDE_DIRECTORIES(HttpsBackend SYSTEM INTERFACE ${OPENSSL_INCLUDE_DIR})
		TARGET_LINK_LIBRARIES(HttpsBackend INTERFACE ${OPENSSL_LIBRARIES})
	...
	ELSEIF(HTTPS_BACKEND STREQUAL "mbedTLS")
		...
		SET(GIT_MBEDTLS 1 PARENT_SCOPE)
		ADD_LIBRARY(HttpsBackend INTERFACE)
		TARGET_INCLUDE_DIRECTORIES(HttpsBackend SYSTEM INTERFACE ${MBEDTLS_INCLUDE_DIR})
		TARGET_LINK_LIBRARIES(HttpsBackend INTERFACE ${MBEDTLS_LIBRARIES})
	...
	ELSEIF (HTTPS_BACKEND STREQUAL "WinHTTP")
		...
		ADD_LIBRARY(HttpsBackend ALIAS WinHTTP)
	ELSE()
...
SET(GIT_HTTPS ${GIT_HTTPS} PARENT_SCOPE)
SET(HTTPS_BACKEND ${HTTPS_BACKEND} PARENT_SCOPE)
