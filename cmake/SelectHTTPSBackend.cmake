...
if(USE_HTTPS)
	...
	if(USE_HTTPS STREQUAL "SecureTransport")
		...
		target_include_directories(libgit2_https_backend INTERFACE "${SECURITY_INCLUDE_DIR}")
		target_link_libraries(libgit2_https_backend INTERFACE ${COREFOUNDATION_LDFLAGS} ${SECURITY_LDFLAGS})
	...
	elseif(USE_HTTPS STREQUAL "OpenSSL")
		...
		set(GIT_OPENSSL 1)
		target_link_libraries(libgit2_https_backend INTERFACE OpenSSL::SSL)
		# Static OpenSSL (lib crypto.a) requires libdl, include it explicitly
		if(LINK_WITH_STATIC_LIBRARIES STREQUAL ON)
			target_link_libraries(libgit2_https_backend INTERFACE ${CMAKE_DL_LIBS})
		endif()
	...
	elseif(USE_HTTPS STREQUAL "mbedTLS")
		...
		set(GIT_MBEDTLS 1)
		target_link_libraries(libgit2_https_backend INTERFACE ${MBEDTLS_LIBRARIES})
		target_include_directories(libgit2_https_backend INTERFACE "${MBEDTLS_INCLUDE_DIR}")
	...
	elseif(USE_HTTPS STREQUAL "Schannel")
		set(GIT_SCHANNEL 1)
		target_link_libraries(libgit2_https_backend INTERFACE "rpcrt4" "crypt32" "ole32")
	...
	elseif(USE_HTTPS STREQUAL "WinHTTP")
		...
		if(MINGW)
			...
			target_link_libraries(libgit2_https_backend INTERFACE winhttp)
			target_include_directories(libgit2_https_backend INTERFACE "${PROJECT_SOURCE_DIR}/deps/winhttp")
		else()
			target_link_libraries(libgit2_https_backend INTERFACE "winhttp")
