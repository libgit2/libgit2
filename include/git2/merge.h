...
#define GIT_MERGE_FILE_INPUT_INIT {GIT_MERGE_FILE_INPUT_VERSION, NULL, 0, NULL, 0}
...
#define GIT_MERGE_FILE_OPTIONS_INIT {GIT_MERGE_FILE_OPTIONS_VERSION, NULL, \
	NULL, NULL, GIT_MERGE_FILE_FAVOR_NORMAL, GIT_MERGE_FILE_DEFAULT, \
	GIT_MERGE_CONFLICT_MARKER_SIZE}
...
#define GIT_MERGE_OPTIONS_DEFAULT_RENAME_THRESHOLD 50
#define GIT_MERGE_OPTIONS_DEFAULT_TARGET_LIMIT 200

#define GIT_MERGE_OPTIONS_VERSION 1
#define GIT_MERGE_OPTIONS_INIT { \
	GIT_MERGE_OPTIONS_VERSION, 0, GIT_MERGE_OPTIONS_DEFAULT_RENAME_THRESHOLD, \
	GIT_MERGE_OPTIONS_DEFAULT_TARGET_LIMIT, NULL, 0, NULL, \
	GIT_MERGE_FILE_FAVOR_NORMAL, GIT_MERGE_FILE_DEFAULT}
