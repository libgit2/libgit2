...
#define GIT_REMOTE_CALLBACKS_INIT {GIT_REMOTE_CALLBACKS_VERSION, NULL, NULL, \
...
#define GIT_FETCH_OPTIONS_INIT {GIT_FETCH_OPTIONS_VERSION, \
	GIT_REMOTE_CALLBACKS_INIT, GIT_FETCH_PRUNE_UNSPECIFIED, 1, \
	GIT_REMOTE_DOWNLOAD_TAGS_UNSPECIFIED, GIT_PROXY_OPTIONS_INIT, {NULL, 0}}
...
#define GIT_PUSH_OPTIONS_INIT {GIT_PUSH_OPTIONS_VERSION, 1, \
	GIT_REMOTE_CALLBACKS_INIT, GIT_PROXY_OPTIONS_INIT, {NULL, 0}}
