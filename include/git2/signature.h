 ...
 *
 * The buffer is expected to be in the format "Real Name <email> timestamp
 * tzoffset", where `timestamp` is the number of seconds since the Unix epoch
 * and `tzoffset` is the timezone offset in `hhmm` format (note the lack
