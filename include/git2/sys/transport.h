 ...
 */
#ifndef INCLUDE_sys_git_transport_h__
#define INCLUDE_sys_git_transport_h__
...
/**
 * Add a custom transport definition, to be used instead of the built-in
 * transport for a particular URI scheme.  This will apply to all
 * network operations for all repositories in libgit2.
 *
 * The caller is responsible for synchronizing calls to git_transport_register
 * and git_transport_unregister with other calls to the library that
 * instantiate transports.
 *
 * @param prefix The scheme (not ending in "://") to match, e.g. "git", "http"
 *               or "mycustomscheme"
 * @param query_cb Optional callback used to query whether `init_cb` will
 *      provide a transport for this URI
 * @param init_cb The callback used to create an instance of the transport
 * @param param A fixed parameter to pass to cb at creation time
 * @return 0 on success, EEXISTS if the scheme is registered,
 *         or an error code
 */
 ...
 * @return 0 on success, ENOTFOUND if it the scheme was not registered,
 *         or an error code
 */
