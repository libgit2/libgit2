 ...
 *
 * The bundle transport reads references and objects from a git bundle
 * file on the local filesystem.  It supports fetching and cloning; it
 * does not support pushing or shallow operations.
 *
 * @param[out] out The newly created transport (out)
 * @param owner The git_remote which will own this transport
 * @param payload You must pass NULL for this parameter.
