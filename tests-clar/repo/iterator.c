...
void test_repo_iterator__index_autoexpand(void)
{
	git_iterator *i;
	git_index *index;
...
void test_repo_iterator__index_autoexpand_icase(void)
{
	git_iterator *i;
	git_index *index;
	unsigned int caps;
...
void test_repo_iterator__tree_autoexpand(void)
{
	git_iterator *i;
	git_tree *head;
...
void test_repo_iterator__tree_autoexpand_icase(void)
{
	git_iterator *i;
	git_tree *head;
...
void test_repo_iterator__workdir_autoexpand(void)
{
	git_iterator *i;
...
void test_repo_iterator__workdir_autoexpand_icase(void)
{
	git_iterator *i;
	git_iterator_flag_t flag;
