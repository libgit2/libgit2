...
static const struct clay_func _all_callbacks[] = {
    {"parsing", &test_network_remotes__parsing, 0},
	{"refspec_parsing", &test_network_remotes__refspec_parsing, 0},
	{"fnmatch", &test_network_remotes__fnmatch, 0},
	{"transform", &test_network_remotes__transform, 0},
	{"find_invalid_chars_in_oid", &test_object_raw_chars__find_invalid_chars_in_oid, 1},
	{"build_valid_oid_from_raw_bytes", &test_object_raw_chars__build_valid_oid_from_raw_bytes, 1},
	{"succeed_on_copy_oid", &test_object_raw_compare__succeed_on_copy_oid, 2},
	{"succeed_on_oid_comparison_lesser", &test_object_raw_compare__succeed_on_oid_comparison_lesser, 2},
	{"succeed_on_oid_comparison_equal", &test_object_raw_compare__succeed_on_oid_comparison_equal, 2},
	{"succeed_on_oid_comparison_greater", &test_object_raw_compare__succeed_on_oid_comparison_greater, 2},
	{"compare_fmt_oids", &test_object_raw_compare__compare_fmt_oids, 2},
	{"compare_allocfmt_oids", &test_object_raw_compare__compare_allocfmt_oids, 2},
	{"compare_pathfmt_oids", &test_object_raw_compare__compare_pathfmt_oids, 2},
	{"succeed_on_oid_to_string_conversion", &test_object_raw_convert__succeed_on_oid_to_string_conversion, 3},
	{"succeed_on_oid_to_string_conversion_big", &test_object_raw_convert__succeed_on_oid_to_string_conversion_big, 3},
	{"fail_on_invalid_oid_string", &test_object_raw_fromstr__fail_on_invalid_oid_string, 4},
	{"succeed_on_valid_oid_string", &test_object_raw_fromstr__succeed_on_valid_oid_string, 4},
	{"hash_by_blocks", &test_object_raw_hash__hash_by_blocks, 5},
	{"hash_buffer_in_single_call", &test_object_raw_hash__hash_buffer_in_single_call, 5},
	{"hash_vector", &test_object_raw_hash__hash_vector, 5},
	{"hash_junk_data", &test_object_raw_hash__hash_junk_data, 5},
	{"hash_commit_object", &test_object_raw_hash__hash_commit_object, 5},
	{"hash_tree_object", &test_object_raw_hash__hash_tree_object, 5},
	{"hash_tag_object", &test_object_raw_hash__hash_tag_object, 5},
	{"hash_zero_length_object", &test_object_raw_hash__hash_zero_length_object, 5},
	{"hash_one_byte_object", &test_object_raw_hash__hash_one_byte_object, 5},
	{"hash_two_byte_object", &test_object_raw_hash__hash_two_byte_object, 5},
	{"hash_multi_byte_object", &test_object_raw_hash__hash_multi_byte_object, 5},
	{"oid_shortener_no_duplicates", &test_object_raw_short__oid_shortener_no_duplicates, 6},
	{"oid_shortener_stresstest_git_oid_shorten", &test_object_raw_short__oid_shortener_stresstest_git_oid_shorten, 6},
	{"validate_oid_size", &test_object_raw_size__validate_oid_size, 7},
	{"convert_type_to_string", &test_object_raw_type2string__convert_type_to_string, 8},
	{"convert_string_to_type", &test_object_raw_type2string__convert_string_to_type, 8},
	{"check_type_is_loose", &test_object_raw_type2string__check_type_is_loose, 8},
	...
	{"resize", &test_buf_basic__resize, 10},
	{"printf", &test_buf_basic__printf, 10},
	{"dont_traverse_dot", &test_core_dirent__dont_traverse_dot, 11},
	{"traverse_subfolder", &test_core_dirent__traverse_subfolder, 11},
	{"traverse_slash_terminated_folder", &test_core_dirent__traverse_slash_terminated_folder, 11},
	{"dont_traverse_empty_folders", &test_core_dirent__dont_traverse_empty_folders, 11},
	{"traverse_weird_filenames", &test_core_dirent__traverse_weird_filenames, 11},
	{"0", &test_core_filebuf__0, 12},
	{"1", &test_core_filebuf__1, 12},
	{"2", &test_core_filebuf__2, 12},
	{"streq", &test_core_oid__streq, 13},
	{"0", &test_core_path__0, 14},
	{"1", &test_core_path__1, 14},
	{"2", &test_core_path__2, 14},
	{"5", &test_core_path__5, 14},
	{"6", &test_core_path__6, 14},
	{"delete_recursive", &test_core_rmdir__delete_recursive, 15},
	{"fail_to_delete_non_empty_dir", &test_core_rmdir__fail_to_delete_non_empty_dir, 15},
	{"0", &test_core_string__0, 16},
	{"1", &test_core_string__1, 16},
	{"int32", &test_core_strtol__int32, 17},
	{"int64", &test_core_strtol__int64, 17},
	{"0", &test_core_vector__0, 18},
	{"1", &test_core_vector__1, 18},
	{"2", &test_core_vector__2, 18},
	{"hash_single_file", &test_status_single__hash_single_file, 19},
	{"whole_repository", &test_status_worktree__whole_repository, 20},
	{"empty_repository", &test_status_worktree__empty_repository, 20}
};

static const struct clay_suite _all_suites[] = {
    {
        "network::remotes",
        {"initialize", &test_network_remotes__initialize, 0},
        {"cleanup", &test_network_remotes__cleanup, 0},
        &_all_callbacks[0], 4
    },
	{
        "object::raw::chars",
	...
	{
        "core::oid",
        {"initialize", &test_core_oid__initialize, 13},
        {NULL, NULL, 0},
        &_all_callbacks[47], 1
    },
	{
	...
	{
        "core::rmdir",
        {"initialize", &test_core_rmdir__initialize, 15},
        {NULL, NULL, 0},
        &_all_callbacks[53], 2
    },
	{
	...
	{
        "status::worktree",
        {"initialize", &test_status_worktree__initialize, 20},
        {"cleanup", &test_status_worktree__cleanup, 20},
        &_all_callbacks[63], 2
    }
};

static const char _suites_str[] = "network::remotes, object::raw::chars, object::raw::compare, object::raw::convert, object::raw::fromstr, object::raw::hash, object::raw::short, object::raw::size, object::raw::type2string, object::tree::frompath, buf::basic, core::dirent, core::filebuf, core::oid, core::path, core::rmdir, core::string, core::strtol, core::vector, status::single, status::worktree";
