...
void test_index_extension__nonexistant(void)
{
	...
	cl_git_fail_with(GIT_ENOTFOUND, git_index_extension_lookup(&ext, g_index, test_ext_signature));
...
void test_index_extension__add(void)
{
	...
	cl_git_pass(git_index_extension_add(g_index, test_ext_signature, test_ext_data1, sizeof(test_ext_data1)));
	cl_git_pass(git_index_extension_lookup(&ext, g_index, test_ext_signature));
...
void test_index_extension__overwrite(void)
{
	...
	cl_git_pass(git_index_extension_add(g_index, test_ext_signature, test_ext_data2, sizeof(test_ext_data2)));
	cl_git_pass(git_index_extension_lookup(&ext, g_index, test_ext_signature));
