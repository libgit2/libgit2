...
void test_merge_files__automerge_zero_byte(void)
{
	...
	git_oid__fromstr(&ours.id, "e69de29bb2d1d6434b8b29ae775ad8c2e48c5391", GIT_OID_SHA1);
	ours.path = "empty.txt";
	ours.mode = GIT_FILEMODE_BLOB;

	git_oid__fromstr(&theirs.id, "d427e0b2e138501a3d15cc376077a3631e15bd46", GIT_OID_SHA1);
