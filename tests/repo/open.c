...
static void make_gitlink_dir(const char *dir, const char *linktext)
{
	...
	cl_git_pass(git_futils_mkdir(dir, NULL, 0777, GIT_MKDIR_VERIFY_DIR | GIT_MKDIR_PATH));
...
void test_repo_open__gitlinked_long(void)
{
	/* need to have both repo dir and workdir set up correctly */
	git_repository *repo = cl_git_sandbox_init("empty_standard_repo");
	git_repository *repo2;

	make_gitlink_dir("000000000/111111111/222222222/333333333/444444444"
		, "gitdir: ../../../../../000000000/../000000000/../000000000/../000000000/../000000000/../000000000/../000000000/../000000000/../000000000/../000000000/../000000000/../000000000/../000000000/../empty_standard_repo/.git");

	cl_git_pass(git_repository_open(&repo2, "000000000/111111111/222222222/333333333/444444444"));
	...
	cl_assert(git_repository_workdir(repo2) != NULL);
	cl_assert_(git__suffixcmp(git_repository_workdir(repo2), "000000000/111111111/222222222/333333333/444444444/") == 0, git_repository_workdir(repo2));
